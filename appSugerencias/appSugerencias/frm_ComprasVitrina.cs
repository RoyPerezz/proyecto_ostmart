...
{
    public partial class frm_ComprasVitrina : Form
    {
        string Usuario;
        public frm_ComprasVitrina()
        {
            InitializeComponent();
        }
        

        public frm_ComprasVitrina(string usuario)
        {
            InitializeComponent();
            Usuario = usuario;
        }
        ...
        public void ElegirSucursar()
        {
            ...
            {
                conectar = BDConexicon.V_velazquez();
                proveedores();
            }
            ...
            if (CBTienda.SelectedItem.Equals("VALLARTA"))
            {
                ...
                conectar = BDConexicon.V_vallarta();
                proveedores();
            }
            ...
            if (CBTienda.SelectedItem.Equals("PREGOT"))
            {
                ...
                conectar = BDConexicon.V_PregotMina();
                proveedores();
            }
