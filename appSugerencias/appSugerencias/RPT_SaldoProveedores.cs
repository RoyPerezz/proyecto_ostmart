...
namespace appSugerencias
{
    public partial class RPT_SaldoProveedores : Form
    {
        ...
        {
            MySqlCommand cmd = new MySqlCommand("SELECT  p.proveedor,p.nombre,sum(cp.saldo) from proveed p inner join cuenxpag cp on p.proveedor = cp.proveedor GROUP BY p.PROVEEDOR",con);
